  ...
  return (
    <div className="flex h-full flex-col">
      <div
        ...
        className={`prose mb-6 max-w-none [&_p]:leading-tight [&_li]:leading-tight [&_li]:my-0 [&_li]:text-pretty [&_li::marker]:text-inherit [&_h1]:font-[family-name:var(--font-unbounded)] [&_h2]:font-[family-name:var(--font-unbounded)] [&_h3]:font-[family-name:var(--font-unbounded)] [&_h4]:font-[family-name:var(--font-unbounded)] [&_h1]:font-bold [&_h2]:font-bold [&_h3]:font-bold [&_h4]:font-bold [&_h1]:uppercase [&_h2]:uppercase [&_h3]:uppercase [&_h4]:uppercase [&_h1]:text-primary [&_h2]:text-primary [&_h3]:text-primary [&_h4]:text-primary ${unbounded.variable}`}
      />
